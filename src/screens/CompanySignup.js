...
import { Disable, Login, SignupUser } from '../store/actions';
...
function Company(props) {
    ...
    const signupwithEmail = () => {
        if (userName === '' || directorNames === '' || hrNames === '' || phoneNo === '' || userPass === '' || userAddress === '' || userEmail === '' || passError === true || confirmPass === '' || resourcePath === ImageUri) {
            ...
            <View style={styles.container}>
                ...
                <Form>
                    ...
                    <Item floatingLabel style={{ marginEnd: 20 }}>
                        ...
                        <Input value={directorNames} onChangeText={(val) => setDirectorNames(val)} />
                    </Item>
                    <Item floatingLabel style={{ marginEnd: 20 }}>
                        <Label>HR Name</Label>
                        <Input value={hrNames} onChangeText={(val) => setHrNames(val)} />
                    </Item>
                    <Item floatingLabel style={{ marginEnd: 20 }}>
